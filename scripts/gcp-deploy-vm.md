...
```bash
cd /home/your-user/confluent-ai-day
...
gcloud run deploy inatews-backend \
  ...
  --set-env-vars "SERVER_PORT=8080,CORS_ORIGIN=https://your-frontend-domain,DEMO_MODE=false,CONFLUENT_BOOTSTRAP_SERVERS=...,CONFLUENT_API_KEY=...,CONFLUENT_API_SECRET=...,GEMINI_API_KEY=...,AI_PROVIDER=gemini"
```
...
Then mount through runtime secrets or set `--set-secrets`.
